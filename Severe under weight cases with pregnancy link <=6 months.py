...
#df= pd.merge(df,mm, on="pregnancy_id", how='left')
...
writer = ExcelWriter('Child_Severe_Underweight_ANC_Regression_Analysis.xlsx')
...
plt.title('Logistic Regression (Severe underweight case with pregnancy link <=6 months)')
plt.savefig('Child_Severe_Underweight_ANC_Regression_Analysis.png', transparent=False)
...
X_cols = ['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']
...
'''Linear assumptions '''
df_titanic_lt=df[(df['days_to_edd_from_last_checkup']>0) & (df['proportion_of_anemic_cases_reported_in_village']>0)][['severe_underweight','days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']]
# Define continuous variables
continuous_var = ['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village']
...
print(logit_results.summary())
'''
df_titanic_lt=df[['severe_underweight','days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']]
...
cols_to_keep =['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']
...
anc=df[['severe_underweight','days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']]
...
import matplotlib.pyplot as plt
X_lt = sm.add_constant(anc[['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']], prepend=False)
...
X_train,X_test, y_train, y_test = train_test_split(logs_train[['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']], logs_train['severe_underweight'], test_size=0.1,  random_state=random.seed(1234))


np.random.seed(1234)
oversample = SMOTE()
''' over sampling of minority class'''
over_X, over_y = oversample.fit_resample(logs_train[['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']], logs_train['severe_underweight'])
...
X_train, X_test, y_train, y_test = train_test_split(logs_train[['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']], logs_train['severe_underweight'], test_size=0.2, stratify=logs_train['severe_underweight'], random_state=random.seed(1234))


SMOTE_SRF.fit(over_X_train, over_y_train)
#SMOTE SRF prediction result
y_pred = SMOTE_SRF.predict(logs_train[['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']])
#Create confusion matrix
fig = plot_confusion_matrix(SMOTE_SRF, logs_train[['days_to_edd_from_last_checkup','proportion_of_anemic_cases_reported_in_village','high_risk_during_4th_anc','full_term_delivery','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']], logs_train['severe_underweight'], display_labels=['Severe underweight', 'Normal'], cmap='Greens')
...
for column in ['severe_underweight','days_to_edd_from_last_checkup','full_term_delivery','high_risk_during_4th_anc','proportion_of_anemic_cases_reported_in_village','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']:
...
np.random.seed(42)
''' training dataset'''
part_9 = df.sample(frac = 0.9, random_state=2).reset_index(drop=True)    
''' test dataset'''
...
X=part_9[['days_to_edd_from_last_checkup','full_term_delivery','high_risk_during_4th_anc','proportion_of_anemic_cases_reported_in_village','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']]
...
X_test=rest_part_25[['days_to_edd_from_last_checkup','full_term_delivery','high_risk_during_4th_anc','proportion_of_anemic_cases_reported_in_village','mother_age_greater_than_20_less_than_30','pregnancy_greater_than_3','registered_within_12_weeks','tt_booster_given']]
