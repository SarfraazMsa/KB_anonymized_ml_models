...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 13 22:38:13 2022
...
df = os.path.join("dropout_pregnant_women.csv")
df = pd.read_csv(df)
...
df['fourth_diff'] = (df['anc_date_3']-df['lmp_date']).dt.days    


df['anemia_1_trimester']=np.where(((df['hb_1']<=8) & (df['first_diff']<=90)) | ((df['hb_2']<=8) & (df['first_diff']<=90)) | ((df['hb_3']<=8) & (df['first_diff']<=90)) | ((df['hb_3']<=8) & (df['first_diff']<=90)) | ((df['hb_1']<=8) & (df['second_diff']<=90)) | ((df['hb_2']<=8) & (df['second_diff']<=90)) | ((df['hb_3']<=8) & (df['second_diff']<=90)) | ((df['hb_3']<=8) & (df['second_diff']<=90)) | ((df['hb_1']<=8) & (df['third_diff']<=90)) | ((df['hb_2']<=8) & (df['third_diff']<=90)) | ((df['hb_3']<=8) & (df['third_diff']<=90)) | ((df['hb_3']<=8) & (df['third_diff']<=90)),1,0)
df['anemia_2_trimester']=np.where(((df['hb_1']<=8) & (df['first_diff']>90) & (df['first_diff']<=180)) | ((df['hb_2']<=8) & (df['first_diff']>90) & (df['first_diff']<=180)) | ((df['hb_3']<=8) & (df['first_diff']>90) & (df['first_diff']<=180)) | ((df['hb_3']<=8) & (df['first_diff']>90) & (df['first_diff']<=180)) | ((df['hb_1']<=8) & (df['second_diff']>90) & (df['second_diff']<=180)) | ((df['hb_2']<=8) & (df['second_diff']>90) & (df['second_diff']<=180)) | ((df['hb_3']<=8) & (df['second_diff']>90) & (df['second_diff']<=180)) | ((df['hb_3']<=8) & (df['second_diff']>90) & (df['second_diff']<=180)) | ((df['hb_1']<=8) & (df['third_diff']>90) & (df['third_diff']<=180)) | ((df['hb_2']<=8) & (df['third_diff']>90) & (df['third_diff']<=180)) | ((df['hb_3']<=8) & (df['third_diff']>90) & (df['third_diff']<=180)) | ((df['hb_3']<=8) & (df['third_diff']>90) & (df['third_diff']<=180)),1,0)
...
df['hypertension_1_trimester']=np.where(((df['bp_dia_1']>=90) | (df['bp_sys_1']>=140) & (df['first_diff']<=90)) | ((df['bp_dia_2']>=90) | (df['bp_sys_2']>=140) & (df['first_diff']<=90)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['first_diff']<=90)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['first_diff']<=90)) | ((df['bp_dia_1']>=90) | (df['bp_sys_1']>=140) & (df['second_diff']<=90)) | ((df['bp_dia_2']>=90) | (df['bp_sys_2']>=140) & (df['second_diff']<=90)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['second_diff']<=90)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['second_diff']<=90)) | ((df['bp_dia_1']>=90) | (df['bp_sys_1']>=140) & (df['third_diff']<=90)) | ((df['bp_dia_2']>=90) | (df['bp_sys_2']>=140) & (df['third_diff']<=90)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['third_diff']<=90)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['third_diff']<=90)),1,0)
df['hypertension_2_trimester']=np.where(((df['bp_dia_1']>=90) | (df['bp_sys_1']>=140) & (df['first_diff']>90) & (df['first_diff']<=180)) | ((df['bp_dia_2']>=90) | (df['bp_sys_2']>=140) & (df['first_diff']>90) & (df['first_diff']<=180)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['first_diff']>90) & (df['first_diff']<=180)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['first_diff']>90) & (df['first_diff']<=180)) | ((df['bp_dia_1']>=90) | (df['bp_sys_1']>=140) & (df['second_diff']>90) & (df['second_diff']<=180)) | ((df['bp_dia_2']>=90) | (df['bp_sys_2']>=140) & (df['second_diff']>90) & (df['second_diff']<=180)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['second_diff']>90) & (df['second_diff']<=180)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['second_diff']>90) & (df['second_diff']<=180)) | ((df['bp_dia_1']>=90) | (df['bp_sys_1']>=140) & (df['third_diff']>90) & (df['third_diff']<=180)) | ((df['bp_dia_2']>=90) | (df['bp_sys_2']>=140) & (df['third_diff']>90) & (df['third_diff']<=180)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['third_diff']>90) & (df['third_diff']<=180)) | ((df['bp_dia_3']>=90) | (df['bp_sys_3']>=140) & (df['third_diff']>90) & (df['third_diff']<=180)),1,0)
...
df['high_risk_mother']=np.where((df['high_risk_1']>0) | (df['high_risk_2']>0) | (df['high_risk_3']>0) ,1,0)
...
df=df[df['edd']<=datetime.date(2022,7,23)]

model = smf.logit("dropout~tt_1_given+tt_2_given+tt_booster_given+pregnancy_greater_than_3+mother_age_greater_than_35+weight_1+low_height+high_risk_mother+days_to_edd_from_last_checkup+anemia_2_trimester+anemia_3_trimester+hypertension_1_trimester+anm_average_data_quality_score+anemia_1_trimester+registered_within_12_weeks", data=df)
...
writer = ExcelWriter('ANC_Dropout_Regression_Analysis.xlsx')
model_odds.to_excel(writer,'ANC_Dropout_Regression',encoding='utf-8-sig',index=True)
writer.save()
...
plt.title('Regression Model (ANC Dropout)')
plt.savefig('ANC_Dropout_Regression_Analysis.png', transparent=False)
...
X_cols = ['tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']
Xx = df[X_cols]
...
'''Linear assumptions '''
df_titanic_lt=df[(df['weight_1']>0) & (df['anm_average_data_quality_score']>0) & (df['days_to_edd_from_last_checkup']>0)][['tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks','weight_1','anm_average_data_quality_score','days_to_edd_from_last_checkup','dropout']]


continuous_var = [ 'weight_1','anm_average_data_quality_score','days_to_edd_from_last_checkup']
...
#df_titanic_lt['weight_1']=np.log2(df_titanic_lt['weight_1'])
#df_titanic_lt['days_to_edd_from_last_checkup']=np.log2(df_titanic_lt['days_to_edd_from_last_checkup'])
#df_titanic_lt['anm_average_data_quality_score']=np.log2(df_titanic_lt['anm_average_data_quality_score'])

# Keep columns related to continuous variables
cols_to_keep = continuous_var + df_titanic_lt.columns.tolist()[-len(continuous_var):]
# Redefine independent variables to include interaction terms

#df_titanic_lt['anm_average_data_quality_score']=df_titanic_lt['anm_average_data_quality_score']**6
import numpy as np
...
cols_to_keep = continuous_var + df_titanic_lt.columns.tolist()[-len(continuous_var):]
# Redefine independent variables to include interaction terms
df_titanic_lt['weight_1']=(df_titanic_lt['weight_1'])**5
...
df_titanic_lt=df[['tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','weight_1','low_height','high_risk_mother','days_to_edd_from_last_checkup','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anm_average_data_quality_score','anemia_1_trimester','registered_within_12_weeks','dropout']]

X_cols = ['tt_1_given',"anm_average_data_quality_score",'tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']
Xx = df[X_cols]
df_titanic_lt=pd.DataFrame((imp.fit_transform(df_titanic_lt)),columns =df_titanic_lt.columns)
import matplotlib.pyplot as plt
X_lt = sm.add_constant(df_titanic_lt[['weight_1','anm_average_data_quality_score','days_to_edd_from_last_checkup','tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']], prepend=False)
y_lt=df_titanic_lt[['dropout']]
...
X_lt = df_titanic_lt[['tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']]
y_lt = df_titanic_lt[['dropout']]
...
anc=df[['dropout','tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','weight_1','low_height','high_risk_mother','days_to_edd_from_last_checkup','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anm_average_data_quality_score','anemia_1_trimester','registered_within_12_weeks']]
...
import matplotlib.pyplot as plt
X_lt = sm.add_constant(anc[['tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']], prepend=False)
y_lt=anc[['dropout']]
# Re-run logistic regression on original set of X and y variables
logit_results = GLM(y_lt, X_lt, family=families.Binomial()).fit()
predicted = logit_results.predict(X_lt)
...
writercsv = os.path.join("dropout_assumptions_check.csv")
...
logs_train['anm_average_data_quality_score']=logs_train['anm_average_data_quality_score']**6
logs_test['anm_average_data_quality_score']=logs_test['anm_average_data_quality_score']**6
...
X_train,X_test, y_train, y_test = train_test_split(logs_train[['tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']], logs_train['dropout'], test_size=0.1,  random_state=random.seed(1234))


np.random.seed(1234)
oversample = SMOTE()
''' over sampling of minority class'''
over_X, over_y = oversample.fit_resample(logs_train[[ 'tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']], logs_train['dropout'])
...
X_train, X_test, y_train, y_test = train_test_split(logs_train[[ 'tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']], logs_train['dropout'], test_size=0.2, stratify=logs_train['dropout'], random_state=random.seed(1234))


SMOTE_SRF.fit(over_X_train, over_y_train)
#SMOTE SRF prediction result
y_pred = SMOTE_SRF.predict(logs_train[[ 'tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']])
#Create confusion matrix
fig = plot_confusion_matrix(SMOTE_SRF, logs_train[[ 'tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','low_height','high_risk_mother','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anemia_1_trimester','registered_within_12_weeks']], logs_train['dropout'], display_labels=['Not a dropout', 'Dropout'], cmap='Greens')
plt.title('Logistic Regression Confusion Matrix')
plt.show()

from sklearn.metrics import confusion_matrix
cf_matrix = confusion_matrix(logs_train['dropout'], y_pred)
print(cf_matrix)
...
#Create confusion matrix
fig = plot_confusion_matrix(SMOTE_SRF, X_test, y_test, display_labels=['Not a dropout', 'Dropout'], cmap='Reds')
...
X=part_9[['tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','weight_1','low_height','high_risk_mother','days_to_edd_from_last_checkup','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anm_average_data_quality_score','anemia_1_trimester','registered_within_12_weeks']]
...
#Create confusion matrix
fig = plot_confusion_matrix(SMOTE_SRF, X ,y, display_labels=['Not Dropout', 'Dropout'], cmap='Greens')
plt.title('SMOTE + Standard Random Forest Confusion Matrix')
plt.show()
...
y_test=rest_part_25[['dropout']]

X_test=rest_part_25[['tt_1_given','tt_2_given','tt_booster_given','pregnancy_greater_than_3','mother_age_greater_than_35','weight_1','low_height','high_risk_mother','days_to_edd_from_last_checkup','anemia_2_trimester','anemia_3_trimester','hypertension_1_trimester','anm_average_data_quality_score','anemia_1_trimester','registered_within_12_weeks']]
...
y_pred = SMOTE_SRF.predict(X_test)
#Create confusion matrix
fig = plot_confusion_matrix(SMOTE_SRF, X_test, y_test, display_labels=['Not Dropout', 'Dropout'], cmap='Reds')
plt.title('SMOTE + Standard Random Forest Confusion Matrix')
plt.show()
...
import random as rn
rn.seed(1254)
horizontal_concat = pd.concat([training_features, training_target], axis=1)
 
df_majority = horizontal_concat[horizontal_concat['dropout']==1]
df_minority = horizontal_concat[horizontal_concat['dropout']==0]
 
# Downsample majority class

df_minority = resample(df_minority, replace=True, n_samples=int(len(df_majority)),random_state=random.seed(1234))# Combine minority class with downsampled majority class
df_up_down_sampled = pd.concat([df_majority, df_minority])

training=df_up_down_sampled.drop('dropout', axis=1)
target=df_up_down_sampled[['dropout']]

x_train, x_val, y_train, y_val = train_test_split(training, target,
                                                  test_size = .1,random_state=random.seed(1234))


model_1 = Sequential(random.seed(1234))
model_1.add(Dense(80, input_dim=15, activation='relu'))
...
model_1.fit(x_train,y_train  , epochs=500,batch_size=500)
...
ax.set_title('ANC dropout model - Random Forest');
ax.set_xlabel('\nThe Truth')
ax.set_ylabel('Test Score ');

## Ticket labels - List must be in alphabetical order
ax.xaxis.set_ticklabels(['Dropout (Positive)','Not dropout (Negative)'])
...
ax.set_title('ANC Dropout Model - Deep Neural Network');
ax.set_xlabel('\nThe Truth')
ax.set_ylabel('Test Score ');

## Ticket labels - List must be in alphabetical order
ax.xaxis.set_ticklabels(['ANC dropout (positive)','Not a dropout (negative)'])
ax.yaxis.set_ticklabels(['Positive','Negative'])
...
# title
plt.title('ROC Curve - ANC Dropout model')
...
def sensitivity_check(training_features,training_target,sampling_ratio,ax_title,ax_tick_labels):
    ...
    df_minority = resample(df_minority, replace=True, n_samples=int(len(df_majority)*sampling_ratio),random_state=random.seed(1234))# Combine minority class with downsampled majority class
    df_up_down_sampled = pd.concat([df_majority, df_minority])
    ...
    (cf_matrix)[0][0]=b
    (cf_matrix)[1][1]=a
    print("ANC Dropout - "+ str(sampling_ratio))
    print(cf_matrix)
    group_names = ['','','','']
    #zs=np.array([48, 179,  13,  958])
    group_names = ['','','','']
...
rf_10=sensitivity_check(training_features,training_target,0.1,'ANC Dropout Model - Random Forest (10% Over Sampling)',['ANC dropout (positive)','Not a dropout (negative)'])
rf_30=sensitivity_check(training_features,training_target,0.3,'ANC Dropout Model - Random Forest (30% Over Sampling)',['ANC dropout (positive)','Not a dropout (negative)'])
rf_50=sensitivity_check(training_features,training_target,0.5,'ANC Dropout Model - Random Forest (50% Over Sampling)',['ANC dropout (positive)','Not a dropout (negative)'])
rf_70=sensitivity_check(training_features,training_target,0.7,'ANC Dropout Model - Random Forest (70% Over Sampling)',['ANC dropout (positive)','Not a dropout (negative)'])
rf_90=sensitivity_check(training_features,training_target,0.9,'ANC Dropout Model - Random Forest (90% Over Sampling)',['ANC dropout (positive)','Not a dropout (negative)'])
